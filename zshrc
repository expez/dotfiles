...
alias grr='g remote rm'
alias gpu='g pull'
alias gcl='g clone'
alias git-add-modified="g status | grep modified | cut -d':' -f2 | xargs git add"
alias git-add-deleted="g status | grep deleted | cut -d':' -f2 | xargs git add"
alias git-rm-modified="g status | grep modified | cut -d':' -f2 | xargs git rm"
alias git-rm-deleted="g status | grep deleted | cut -d':' -f2 | xargs git rm"
